...
Traditional surface-to-air missile systems like [Patriot](https://norskluftvern.com/2025/06/28/patriot-missile-systems-empirical-performance-data-2020-2025/) and [SAMP/T](https://norskluftvern.com/2024/05/01/samp-t-the-european-patriot/) have demonstrated effectiveness against larger drone threats, particularly Group 3 and Group 4 UAVs. Ukraine’s deployment demonstrated combat efficacy, with a SAMP/T battery intercepting a Russian jet at 90-mile ranges in March 2025. Each $500 million battery can fire 8 missiles in 10 seconds. However, these systems face cost-effectiveness challenges when engaging smaller threats, with interceptor costs ranging from $480,000 (Stinger) to $2.1 million (Standard Missile-2).

### Short-Range Air Defense (SHORAD) Systems

Modern SHORAD platforms have adapted to address the drone threat through specialized ammunition and fire control systems. Electric Optic Systems based in Australia recently sent 160 of its [Slinger counter-drone systems (external link)](https://eos-aus.com/wp-content/uploads/2023/11/EOS-Defence-Slinger-flyer.pdf) to Ukraine. Using a Bushmaster M230LF 30 x 113mm cannon, coupled with proximity fused, high explosive fragmentation rounds, the Slinger can automatically track and eliminate moving targets beyond 800 meters. These systems represent the bridge between traditional air defense and specialized C-UAS capabilities.

![](https://norskluftvern.wordpress.com/wp-content/uploads/2025/07/img_8137-1.jpg?w=1024)
*Slinger (eos-aus)*

### Dedicated Kinetic Solutions

Purpose-built kinetic interceptors like the [Coyote Block 2](https://norskluftvern.com/2025/03/31/coyote-block-2-counter-drone-system-us/) provide mid-range solutions for drone threats. The Army in February inked a deal with defense contractor Raytheon for hundreds of Coyote Block 2C interceptors – at $100,000 a shot – explicitly to support its counter-drone initiatives in the Middle East. These interceptors offer improved cost-effectiveness compared to traditional missiles while maintaining kinetic kill capabilities.
...
Directed energy weapons have emerged as game-changing technology for counter-drone operations. Israel has used a new air defense laser to shoot down Hezbollah drones in the current conflict in the Middle East, it has been confirmed. The [Iron Beam](https://norskluftvern.com/2025/04/11/iron-beam-laser-innovation-redefining-short-range-air-defenses-and-global-markets/) system represents the world’s first operationally deployed combat laser, successfully engaging multiple aerial targets.
...
- The Army has not only deployed a platoon of four 50-kilowatt Directed Energy Maneuver-Short Range Air Defense, or [DE M-SHORAD](https://norskluftvern.com/2025/04/12/redefining-the-battlefield-how-wide-proliferation-of-high-powered-laser-air-defenses-can-transform-operations/), prototypes to Central Command for “real world testing,” but taken possession of its most powerful laser yet – the 300-kilowatt Indirect Fire Protection Capability-High Energy Laser
...
- **Detection Layer:** Radar, electro-optical, and acoustic sensors

- **Soft-Kill Layer:** Electronic warfare and GPS jamming

- **Hard-Kill Layer:** Directed energy and kinetic interceptors

- **Command Integration:** AI-enabled threat assessment and engagement coordination

### Technology Investment Priorities

Based on operational evidence, investment should prioritize:

- **Directed Energy Systems:** Superior cost-effectiveness for sustained operations

- **AI Integration:** Essential for managing complex multi-threat environments

- **Mobile Platforms:** Critical for tactical flexibility

- **Sensor Fusion:** Necessary for reliable detection in contested environments
...
*For the latest developments in air defense technology and detailed system comparisons, continue following our analysis at norskluftvern.com*
